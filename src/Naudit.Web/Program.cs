...
builder.Services.AddDataProtection()
    ...
    .SetApplicationName(Naudit.Infrastructure.Settings.DbSettingsLoader.DataProtectionAppName);
...
// Persistenz: DB und UI sind immer an — Migration und Seed-Admin laufen bei jedem Start.
...
// WebUI-Endpoints: immer gemappt (die UI ist immer an).
